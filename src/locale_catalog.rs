...
pub(super) fn message_attribute(source: &str) -> Option<(&'static str, &'static str)> {
    match source {
        ...
        "XREF: '{}' ships with reference operations (Task 8/9)." => Some(("insert", "xref-ships-with-reference-operations")),
        ...
        "Reference Manager" => Some(("insert", "xref-manager-title")),
        ...
        "XREF  Recovered with warnings: \"{}\"" => Some(("file", "xref-recovered-with-warnings")),
        "XREF  Recovery failed: \"{}\" ({})" => Some(("file", "xref-recovery-failed")),
        "XREF  Reload failed: \"{}\" ({})" => Some(("insert", "xref-reload-failed")),
        "XREF  Reloaded with repairs: \"{}\"" => Some(("insert", "xref-reloaded-with-repairs")),
        ...
        "PDF" => Some(("insert", "pdf")),
        "Reference Manager — select rows, then Detach, Unload, Reload, Overlay, or a Change Path mode." => Some(("insert", "xref-reference-manager-select-rows")),
